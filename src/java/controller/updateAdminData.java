 ...
 * @author Sarthak Jain
 */
@WebServlet(name = "updateAdminData", urlPatterns = {"/updateAdminData"})
public class updateAdminData extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		a.setUid((String)request.getSession().getAttribute("id"));
		a.setEmail(request.getParameter("email"));
		a.setContactNo(Long.parseLong(request.getParameter("tel")));
		...
		out.println("location = 'dashboardAdmin.jsp';");
		out.println("</script>");
    }
