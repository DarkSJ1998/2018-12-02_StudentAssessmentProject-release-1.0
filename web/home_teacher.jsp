<%-- 
    ...
    Created on : Nov 15, 2018, 10:32:32 PM
    Author     : Sarthak Jain
--%>
...
<html>
    <head>
        <title>ScoreBook | Home - Faculty Panel</title>
        <meta charset="UTF-8">
    ...
    <body background = "sources\grey-chevron-stripes-1920.png" style = "background-attachment: fixed;">
        ...
        <iframe src = "buttons_teacher.html" name = "tabs" width = "100%" height = "44px"> iframe1 </iframe><br><br>
		<iframe src = "dashboardTeacher.jsp" name = "output" width = "100%" height = "600px"> iframe2 </iframe>
		</div>
